...
import me.dragospiro98.castle.bukkit.data.blocks.GuardianSpawner;
...
public class RootUserCommads {
    ...
    private CommandAPICommand onCastleCommand() {
        return new CommandAPICommand("castle") // TODO: Cambiare comando base
                .withPermission("parties.test.castle") // TODO: Cambiare permesso
    ...
    private CommandAPICommand onCastleCreateCommand() {
        return new CommandAPICommand("create")
                .executesPlayer(((player, args) -> {
                    ...
                    ItemStack guardian_spawner = new BlockBuilder(CustomBlockTypes.GUARDIAN_SPAWNER,plugin).build();
